    ...
    $.ajax({
      ...
      success: function (response) {
        ...
        if (response.hasOwnProperty("error_pName")) {
          $("#pName")
          .addClass("error")
          .attr('placeholder', response.error_pName).addClass("placeholder-set");
        }
        if (response.hasOwnProperty("error_location")) {
          $("#pLocation")
          .addClass("error")
          .attr('placeholder', response.error_location).addClass("placeholder-set");
        }
        if (response.hasOwnProperty("error_startDate")) {
          $("#startDate")
          .addClass("error")
          .attr('placeholder', response.error_startDate).addClass("placeholder-set");
        }
        if (response.hasOwnProperty("error_endDate")) {
          $("#endDate")
          .addClass("error")
          .attr('placeholder', response.error_endDate).addClass("placeholder-set");
        }
        ...
        if (response.hasOwnProperty("error_abcQuantity")) {
          $("#abcQuantity")
          .addClass("error")
          .attr('placeholder', response.error_abcQuantity).addClass("placeholder-set");
        }
        if (response.hasOwnProperty("error_abcRate")) {
          $("#abcRate")
          .addClass("error")
          .attr('placeholder', response.error_abcRate).addClass("placeholder-set");
        }
        ...
        if (response.hasOwnProperty("error_primeQuantity")) {
          $("#primeQuantity")
          .addClass("error")
          .attr('placeholder', response.error_primeQuantity).addClass("placeholder-set");
        }
        if (response.hasOwnProperty("error_primeRate")) {
          $("#primeRate")
          .addClass("error")
          .attr('placeholder', response.error_primeRate).addClass("placeholder-set");
        }
        ...
        if (response.hasOwnProperty("error_tackQuantity")) {
          $("#tackQuantity")
          .addClass("error")
          .attr('placeholder', response.error_tackQuantity).addClass("placeholder-set");
        }
        if (response.hasOwnProperty("error_tackRate")) {
          $("#tackRate")
          .addClass("error")
          .attr('placeholder', response.error_tackRate).addClass("placeholder-set");
        }
        ...
        if (response.hasOwnProperty("error_asphaltThicknes")) {
          $("#asphaltThicknes")
          .addClass("error")
          .attr('placeholder', response.error_asphaltThicknes).addClass("placeholder-set");
        }
        ...
        if (response.hasOwnProperty("error_asphaltQuantity")) {
          $("#asphaltQuantity")
          .addClass("error")
          .attr('placeholder', response.error_asphaltQuantity).addClass("placeholder-set");
        }
        if (response.hasOwnProperty("error_asphaltRate")) {
          $("#asphaltRate")
          .addClass("error")
          .attr('placeholder', response.error_asphaltRate).addClass("placeholder-set");
        }
        ...
        if (response.hasOwnProperty("error_bridges")) {
          $("#bridges")
          .addClass("error")
          .attr('placeholder', response.error_bridges).addClass("placeholder-set");
        }
        if (response.hasOwnProperty("error_pCost")) {
          $("#pCost")
          .addClass("error")
          .attr('placeholder', response.error_pCost).addClass("placeholder-set");
        }
      },
