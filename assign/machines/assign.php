...
<main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
    <div class="d-flex p-2 justify-content-between flex-wrap flex-md-nowrap align-items-center" id="form-header">
        <h4>Here! Manage Machine Assigns</h4>
        <div>
            <button type="button" class="btn btn-sm px-4 border-bottom border-end border-2" onclick="document.location='<?= SYSTEM_PATH; ?>assign/machines/addAssign.php'">
                ...
                <div class="modal-body">
                    <form id="filter-form">
                        <div class="row row-cols-2 row-cols-lg-1">
                            <div class="col-4">
                                <div class="input-field">
                                    ...
                                    <select class="bg-body" id="assignId" name="assignId">
                                        ...
                                        $sql = "SELECT `assign_id` FROM tbl_machine_assign";
                                        $db = dbConn();
                                        $result = $db->query($sql);
                            ...
                            <div class="col-4">
                                <div class="input-field">
                                    <label for="payed_method">Machine ID</label>
    ...
    <div class="card shadow" id="form-card">
        <div class="card-body">
            <h4>List of Assigns</h4>
            <div class="table-responsive">
                <?php
                // Create SQL Query
                $sql = "SELECT `assign_id`, `project_id`,`machine_id`,`assign_date`,`return_date` FROM tbl_machine_assign";
