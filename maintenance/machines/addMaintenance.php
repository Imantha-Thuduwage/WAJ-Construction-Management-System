...
<main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
    ...
    <div class="card shadow" id="form-card">
        <div class="card-body">
            ...
            <form method="post" class="form" id="maintenance-form" action="saveMaintenance.php">
...
<script src="<?= SYSTEM_PATH; ?>assets/js/maintenance/machines/addMaintenance.js"></script>
