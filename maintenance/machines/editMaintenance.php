...
<main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
    <div class="d-flex p-2 justify-content-between flex-wrap flex-md-nowrap align-items-center" id="form-header">
        ...
        <div>
            <button type="button" class="btn btn-sm px-4 border-bottom border-end border-2" onclick="document.location='<?= SYSTEM_PATH; ?>maintenance/machines/maintenance.php'">
    ...
    if ($_SERVER['REQUEST_METHOD'] == 'GET') {
        ...
        $sql = "SELECT * FROM tbl_machine_maintenance WHERE maintenance_id='$maintenance_id'";
        $db = dbConn();
        $result = $db->query($sql);
        ...
        <div class="card-body">
            ...
            <form method="post" class="form" id="maintenance-form">
                <div class="container field p-0">
                    ...
                    <input type="hidden" name="maintenanceId" value="<?php echo $maintenanceId ?>">
                    <div class="row justify-content-center gx-5">
                        <div class="col-sm-6">
                            <div class="input-field">
                                <label for="machine_id" class="mb-1">Machine ID</label>
                                <select class="bg-body" id="machineId" name="machineId">
                                    <option value="">Pick an Machine ID</option>

                                    <?php
                                    // Retrieve data from MySQL database
                                    $sql = "SELECT machine_id FROM tbl_machine_maintenance";
                                    $db = dbConn();
                                    $result = $db->query($sql);
                    ...
                    <div class="row justify-content-center gx-5">
                        <div class="col-6">
                            <div class="input-field">
                                ...
                                <input class="p-3 bg-body" id="maintainedDate" type="text" onfocus="(this.type='date')" placeholder="Pickup Date" name="maintainedDate" value="<?php echo $maintainedDate ?>">
                            </div>
                        </div>
                    </div>
                    <div class="row justify-content-center gx-5">
                        <div class="col-6">
                            <div class="input-field">
                                ...
                                <textarea class="p-3 bg-body" id="description" type="text" placeholder="Enter Any Special Notes" name="description"><?php echo $description ?></textarea>
                            </div>
                        </div>
                    </div>
                    <div class="row justify-content-center gx-5">
...
<script src="<?= SYSTEM_PATH; ?>assets/js/maintenance/machines/editMaintenance.js"></script>
