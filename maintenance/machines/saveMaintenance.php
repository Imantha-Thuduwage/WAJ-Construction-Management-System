...
if (!empty($errors)) {
    ...
    $sql = "INSERT INTO tbl_machine_maintenance
            (`machine_id`, `maintenance_date`, `special_note`, `add_user`, `add_date`) 
            VALUES ('$machineId', '$maintainedDate', '$description', '$addUser', '$addDate')";
    $db = dbConn();
    if ($db->query($sql)) {
