...
<main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
    <div class="d-flex p-2 justify-content-between flex-wrap flex-md-nowrap align-items-center" id="form-header">
        ...
        <div>
            <button type="button" class="btn btn-sm px-4 border-bottom border-end border-2" onclick="document.location='<?= SYSTEM_PATH; ?>maintenance/tools/maintenance.php'">
    ...
    if ($_SERVER['REQUEST_METHOD'] == 'GET') {
        ...
        $sql = "SELECT * FROM tbl_tool_maintenance WHERE maintenance_id='$maintenance_id'";
        $db = dbConn();
        $result = $db->query($sql);
                        ...
                        <div class="col-sm-6">
                            <div class="input-field">
                                ...
                                <select class="bg-body" id="toolId" name="toolId">
                                    <option value="">Pick an Tool ID</option>

                                    <?php
                                    // Retrieve data from MySQL database
                                    $sql = "SELECT tool_id FROM tbl_tool_maintenance";
                                    $db = dbConn();
                                    $result = $db->query($sql);
...
<script src="<?= SYSTEM_PATH; ?>assets/js/maintenance/tools/editMaintenance.js"></script>
